class Game {
  ...
  wallBuster = () => {
    ...
    switch (this.player.direction) {
      case 'N':
        if (this.player.position.up != 1 && this.player.position.up != 0) {
        ...
        break;
      case 'S':
        if (this.player.position.down != 1 && this.player.position.down != 0) {
        ...
        break;
      case 'W':
        if (this.player.position.left != 1 && this.player.position.left != 0) {
          if (this.player.position.left >= 3) {
            this.map.mapArray[this.player.mapX][this.player.mapY - 1] -= 1;
          } else {
            this.map.mapArray[this.player.mapX][this.player.mapY - 1] = 1;
      ...
      switch (this.player.direction) {
        case 'N':
          if (this.player.position.up === 1) {
            this.map.mapArray[this.player.mapX + 1][this.player.mapY] = 3;
            this.bricks--;
            generateNewMap();
          }
          break;
        ...
        case 'W':
          if (this.player.position.right === 1) {
            this.map.mapArray[this.player.mapX][this.player.mapY + 1] = 3;
            this.bricks--;
            generateNewMap();
          }
          break;
